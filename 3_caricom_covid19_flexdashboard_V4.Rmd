...
```{r}
valueBox(caricom_totals$total_confirmed, icon = "fa-pencil")
```

### Confirmed Deaths in CARICOM

```{r}
valueBox(caricom_totals$total_deaths, icon = "fa-pencil")
```

### Total Recoveries in CARICOM

```{r}
valueBox(caricom_totals$total_recovered, icon = "fa-pencil")
```
